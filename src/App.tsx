      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/auth/individual/signup" element={<IndividualSignup />} />
            <Route path="/auth/individual/login" element={<IndividualLogin />} />
            <Route path="/auth/industry/signup" element={<IndustrySignup />} />
